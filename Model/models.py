...
df_metrics.to_csv(f"/rds/general/user/meb22/home/UKBB/Prediction_proteomics/New/Model/Results/Predictions{model_name}_{prefix}_{imputer_name}_{metric_optimising}_{dataset_name}_metrics.csv", index=False)
feature_importances.to_csv(f"/rds/general/user/meb22/home/UKBB/Prediction_proteomics/New/Model/Results/Predictions{model_name}_{prefix}_{imputer_name}_{metric_optimising}_{dataset_name}_Featureimportance.csv", index=False)