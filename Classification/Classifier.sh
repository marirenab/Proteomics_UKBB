...
TRAINING_FILES=(
"/rds/general/user/meb22/home/UKBB/Prediction_proteomics/New/Classification/Training_baseline.csv"
...
PROTEIN_FILES=(
    "/rds/general/user/meb22/home/UKBB/Prediction_proteomics/New/Classification/proteins_matched_baseline_PD_HC_list.txt"
     "/rds/general/user/meb22/home/UKBB/Prediction_proteomics/New/Classification/proteins_matched_baseline_PD_HC_unique_list.txt"
)
...
python '/rds/general/user/meb22/home/UKBB/Prediction_proteomics/New/Classification/models.py' "$dataset" "$model" "$protein_file" "$imputer" "$metrics_opt" 
